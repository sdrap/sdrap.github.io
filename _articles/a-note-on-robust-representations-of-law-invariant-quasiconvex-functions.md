---
layout: page
title: A Note on Robust Representations of Law-Invariant Quasiconvex Functions 
---
{% assign publications = site.data.publications | where: "title","A Note on Robust Representations of Law-Invariant Quasiconvex Functions" %}
