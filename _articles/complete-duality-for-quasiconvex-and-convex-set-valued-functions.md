---
layout: page
title: Complete Duality for Convex and Quasiconvex Set-Valued Functions
---
{% assign publications = site.data.publications | where: "title","Complete Duality for Convex and Quasiconvex Set-Valued Functions" %}
