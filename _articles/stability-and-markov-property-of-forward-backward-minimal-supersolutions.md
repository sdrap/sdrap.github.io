...
---
{% assign publications = site.data.publications | where: "title","Stability and Markov Property of Forward Backward Minimal Supersolutions" %}
...
Download
:   <a href="{{publication.URL_Open}}" target="_blank"> pdf (open science)</a>{% if publication.URL %}<br><a href="{{publication.URL}}" target="_blank">journal link (open science journal)</a>{% endif %}
