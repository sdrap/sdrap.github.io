---
layout: page
title: How Rational Are the Option Prices of Hong Kong Dollar Exchange Rate
---
{% assign publications = site.data.publications | where: "title","How Rational Are the Option Prices of Hong Kong Dollar Exchange Rate" %}
